...
Declares all exchanges, queues, and bindings registered in the [SetupRegistry](/en/1.0.5/registries.html) for each connection
...
Starts all consumers registered in the [ConsumersRegistry](/en/1.0.5/registries.html). Each consumer runs in its own thread.
