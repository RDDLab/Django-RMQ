...
Объявляет все обмены, очереди и привязки, зарегистрированные в [SetupRegistry](/ru/1.0.5/registries.html), для каждого алиаса
...
Запускает всех потребителей, зарегистрированных в [ConsumersRegistry](/ru/1.0.5/registries.html). Каждый потребитель
