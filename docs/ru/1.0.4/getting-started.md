...
См. [Конфигурацию](/ru/1.0.4/configuration.html) для полного справочника параметров и примеров чтения значений из переменных
окружения.
...
Cм. [Продюсеры](/ru/1.0.4/producers.html) для routing keys, кастомных properties, режима exchange-only и стиля декоратора.
...
| Тема                                                                       | Страница                                               |
|----------------------------------------------------------------------------|--------------------------------------------------------|
| Полный справочник конфигурации                                             | [Конфигурация](/ru/1.0.4/configuration.html)                 |
| Продюсеры — режим декоратора, routing через exchange, кастомные properties | [Продюсеры](/ru/1.0.4/producers.html)                        |
| Консьюмеры — поведение при переподключении, DLX, prefetch                  | [Консьюмеры](/ru/1.0.4/consumers.html)                       |
| Объявление exchanges, очередей и bindings                                  | [Топология](/ru/1.0.4/topology.html)                         |
| Реестры и жизненный цикл AppConfig                                         | [Реестры](/ru/1.0.4/registries.html)                         |
| Management-команды                                                         | [Management-команды](/ru/1.0.4/management-commands.html)     |
| Гарантии надёжности                                                        | [Надёжность](/ru/1.0.4/reliability.html)                     |
| Несколько подключений к брокеру                                            | [Несколько подключений](/ru/1.0.4/multiple-connections.html) |
| Полный публичный API                                                       | [Справочник API](/ru/1.0.4/api-reference.html)               |
| Запуск и написание тестов                                                  | [Тестирование](/ru/1.0.4/testing.html)                       |
