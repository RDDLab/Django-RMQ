...
См. [Management-команды](/ru/1.0.4/management-commands.html).
...
См. [Топологию](/ru/1.0.4/topology.html) для настройки полной dead-letter топологии и [Надёжность](/ru/1.0.4/reliability.html) для
гарантий доставки.
...
См. [Реестры](/ru/1.0.4/registries.html) для полного описания паттерна регистрации.

## Смотрите также

- [Топология](/ru/1.0.4/topology.html) — объявление очередей и dead-letter exchanges.
- [Надёжность](/ru/1.0.4/reliability.html) — модель доставки и детали переподключения.
- [Management-команды](/ru/1.0.4/management-commands.html) — `start_consumers` в production.
- [Реестры](/ru/1.0.4/registries.html) — жизненный цикл `ConsumersRegistry`.
- [Справочник API](/ru/1.0.4/api-reference.html) — полная сигнатура `Consumer`.
